...
export default function ArticlePage({ params }: { params: { slug: string } }) {
  ...
  return (
    <article className="container mx-auto px-4 py-8 mt-16 bg-green-50 dark:bg-green-900">
      <h1 className="text-4xl font-bold mb-4 text-green-800 dark:text-green-100">
        {article.title}
      </h1>
